...
public class SUJMessageHandlerPlugin implements Plugin, PacketInterceptor {
     ...
     */
    public static final String VIOLATION_NOTIFICATION_ENABLED_PROPERTY = "plugin.sujMessageHandler.violation.notification.enabled";

    /**
     * The expected value is a user name. The default value is "admin".
     */
    public static final String VIOLATION_NOTIFICATION_CONTACT_PROPERTY = "plugin.sujMessageHandler.violation.notification.contact";
     ...
     */
    public static final String VIOLATION_INCLUDE_ORIGNAL_PACKET_ENABLED_PROPERTY = "plugin.sujMessageHandler.violation.notification.include.original.enabled";
     ...
     */
    public static final String VIOLATION_NOTIFICATION_BY_IM_ENABLED_PROPERTY = "plugin.sujMessageHandler.violation.notification.by.im.enabled";
     ...
     */
    public static final String VIOLATION_NOTIFICATION_BY_EMAIL_ENABLED_PROPERTY = "plugin.sujMessageHandler.violation.notification.by.email.enabled";
     ...
     */
    public static final String REJECTION_NOTIFICATION_ENABLED_PROPERTY = "plugin.sujMessageHandler.rejection.notification.enabled";

    /**
     * The expected value is a string, containing the desired message for the
     * sender notification.
     */
    public static final String REJECTION_MSG_PROPERTY = "plugin.sujMessageHandler.rejection.msg";
     ...
     */
    public static final String PATTERNS_PROPERTY = "plugin.sujMessageHandler.patterns";

    /**
     * The expected value is a boolean, if true Presence packets will be
     * filtered
     */
    public static final String FILTER_STATUS_ENABLED_PROPERTY = "plugin.sujMessageHandler.filter.status.enabled";

    /**
     * The expected value is a boolean, if true the value of #MASK_PROPERTY will
     * be used to mask matching content.
     */
    public static final String MASK_ENABLED_PROPERTY = "plugin.sujMessageHandler.mask.enabled";
     ...
     */
    public static final String MASK_PROPERTY = "plugin.sujMessageHandler.mask";
     ...
     */
    public static final String ALLOW_ON_MATCH_PROPERTY = "plugin.sujMessageHandler.allow.on.match";
    ...
    private void changeContentFilterMask() {
        if (allowOnMatch && maskEnabled) {
            sujMessageHandler.setMask(mask);
        } else {
            sujMessageHandler.clearMask();
        }
    }
    ...
    private void changeContentFilterPatterns() {
        if (patternsEnabled) {
            sujMessageHandler.setPatterns(patterns);
        } else {
            sujMessageHandler.clearPatterns();
        }
    }
    ...
    private void initFilter() {
        ...
        try {
            ...
            Log.warn("Resetting to default patterns of SUJMessageHandlerPlugin", e);
    ...
    public void interceptPacket(Packet packet, Session session, boolean read,
        ...
        if (isValidTargetPacket(packet, read, processed)) {
            ...
            // filter the packet
            boolean contentMatched = sujMessageHandler.filter(packet);
    ...
    private void sendViolationNotification(Packet originalPacket) {
        ...
        if (originalPacket instanceof Message) {
            ...
            body = "Disallowed content detected in message from:"
                    ...
                    + originalMsg.getTo()
                    + ", message was "
                    + (allowOnMatch ? "allowed" + (sujMessageHandler.isMaskingContent() ? " and masked." : " but not masked.") : "rejected.")
