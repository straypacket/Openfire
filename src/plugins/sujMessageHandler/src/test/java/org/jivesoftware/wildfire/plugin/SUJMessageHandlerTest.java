...
/**
 * Basic unit tests for SUJMessageHandler.
 * 
 * @author chayes
 */
public class SUJMessageHandlerTest extends TestCase {
    private SUJMessageHandler filter;

    public static void main(String[] args) {
        junit.textui.TestRunner.run(SUJMessageHandlerTest.class);
    }
