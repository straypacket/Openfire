...
import net.skillupjapan.openfire.SUJGroupConvoInterceptor;
...
/**
 * Openfire SUJ Monitoring plugin.
 * 
 * @author Matt Tucker, Daniel Pereira
 */
public class SUJMonitoringPlugin implements Plugin {
	...
	private static SUJMonitoringPlugin instance;
	...
	public SUJMonitoringPlugin() {
		...
		picoContainer
				.registerComponentImplementation(SUJGroupConvoInterceptor.class);
	...
	public static SUJMonitoringPlugin getInstance() {
		return instance;
	}
	...
	public void initializePlugin(PluginManager manager, File pluginDirectory) {
		...
		System.out.println("Starting SUJ Monitoring Plugin");
		...
		if (jars.length > 0) {
			...
			System.out
					.println("Enterprise plugin found. Stopping SUJ Monitoring Plugin");
